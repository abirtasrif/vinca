...
export const buttonVariants = cva(
  'eoq inline-block whitespace-nowrap rounded-xl border px-5 py-2.5 text-center text-lg disabled:cursor-default disabled:border-gray disabled:bg-gray disabled:text-black',
  {
    variants: {
      variant: {
        primary:
